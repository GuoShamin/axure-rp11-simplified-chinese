...
cp "$ROOT_DIR/README.en.md" "$PACKAGE_DIR/README.en.md"
cp "$ROOT_DIR/AGENTS.md" "$PACKAGE_DIR/AGENTS.md"
cp "$ROOT_DIR/AGENTS.en.md" "$PACKAGE_DIR/AGENTS.en.md"
cp "$ROOT_DIR/CHANGELOG.md" "$PACKAGE_DIR/CHANGELOG.md"
cp "$ROOT_DIR/docs/install-guide.md" "$PACKAGE_DIR/docs/install-guide.md"
